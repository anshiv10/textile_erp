...
ROUTING_FIELDS = {
	...
	"Stock Entry": [{
		...
		"insert_after": "stock_entry_type", "bold": 1, "depends_on": "", "hidden": 0,
...
PROPERTY_SETTERS = [
	...
	("Sales Taxes and Charges", "rate", "in_list_view", "0", "Check"),
	("Purchase Taxes and Charges", "rate", "in_list_view", "0", "Check"),
]
